...
NODES: tuple[Node, ...] = (
    ...
    Node("reddit_algotrading", "intake", "Reddit r/algotrading", passive=True),
    ...
    Node("entry_debate", "decision", "Entry Debate",
         model_badge="Opus 4.7", mailbox=True,
         subscribes=("debate.entry.completed",),
         cadence_label="every BUY signal (post-risk)", process="daemon"),
    ...
    Node("reddit_strategy_bot", "supervision", "Reddit Strategy Bot",
         model_badge="Opus 4.7",
         cadence_label="every 2 days · 23:00 ET · via Claude Code",
         process="mailbox"),
...
EDGES: tuple[tuple[str, str], ...] = (
    ...
    ("risk_gate",       "entry_debate"),
    ("risk_debate",     "decisions_store"),
    ("unblock_debate",  "decisions_store"),
    ("entry_debate",    "decisions_store"),
    ("entry_debate",    "mailbox_routine"),
    ...
    # Reddit strategy bot: ingests r/algotrading, emails digest.
    ("reddit_algotrading",   "reddit_strategy_bot"),
    ("reddit_strategy_bot",  "email_digest"),
)
